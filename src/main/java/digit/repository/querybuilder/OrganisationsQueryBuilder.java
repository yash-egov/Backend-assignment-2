...
public class OrganisationsQueryBuilder {
    ...
    private static final String ORDERBY_CREATEDTIME = " ORDER BY btr.createdtime DESC ";

    public static String getOrganisationSearchQuery(OrgSearchCriteria criteria, List<Object> preparedStmtList) {
...
//        query.append(ORDERBY_CREATEDTIME);
    ...
    private static String createQuery(List<String> ids) {
