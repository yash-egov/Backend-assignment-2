...
/**
 * Object to capture boundary codes where an organisation is authorized to work
 */
@Schema(description = "Object to capture boundary codes where an organisation is authorized to work")
@Validated
